...
class Bill_App:
    def __init__(self,root):
        ...
        #===========Frame Content
        bath_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Bath Soap(Rs40)")
        ...
        #=======Face Cream
        face_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Face Cream(Rs140)")
        ...
        #========Face Wash
        wash_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Face Wash(Rs240)")
        ...
        #========Hair Spray
        hair_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Hair Spray(Rs340)")
        ...
        #============Body Lotion
        lot_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Body Lotion(Rs260)")
        ...
        #===========Frame Content
        rice_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Rice(Rs80)")
        ...
        #=======
        oil_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Food Oil(Rs180)")
        ...
        #=======
        daal_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Dal(Rs80)")
        ...
        #========
        wheat_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Wheat(Rs100)")
        ...
        #============
        sugar_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Sugar(Rs170)")
        ...
        #===========Frame Content
        maza_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Maza(Rs20)")
        ...
        #=======
        cock_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Coke(Rs60)")
        ...
        #=======
        frooti_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Frooti(Rs50)")
        ...
        #========
        cold_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Nimkos(Rs20)")
        ...
        #============
        bis_lbl = Label(F2,font = ("times new roman",12,"bold"),fg = lbl_color,bg = bg_color,text = "Biscuits(Rs20)")
...
#Function For Text Area
    def welcome_soft(self):
        ...
        self.txt.insert(END,"       Welcome To Supermarket\n")
